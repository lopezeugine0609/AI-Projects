...
4. Recommend a VA service package.
5. Produce a CRM payload, response draft, next steps, and discovery questions.

## Future Upgrade

Add an LLM layer to rewrite the response draft in the VA's personal tone, summarize long intake forms, and map leads to a CRM pipeline stage.
